...
public class Automobile {
    ...
    Coordinate position; // Distance between origin and center position of automobile, along Y-axis (in
                         // cm)
    ...
    // Turn left (counter clockwise) by angle mentioned in the chart, without moving
    // forward.
    // call the rotateDirection() functions with a positive angle
    void TurnLeft() {
    };

    // Turn right (clockwise) by angle mentioned in the chart, without moving
    // forward.
